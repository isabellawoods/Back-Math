...
public class AxolotlTest {
    ...
    public static final DeferredItem<Item> MILKED_BUTTER_SWORD = ITEMS.register("milked_butter_sword", () -> new ButterSwordItem(BMItemBehaviors.MILKED_BUTTER, BUTTER_SWORD_SET, 3, -2.4F, new Item.Properties().food(Foods.BAKED_POTATO)));
    ...
    public static final DeferredItem<Item> BUTTER_SWORD = ITEMS.register("butter_sword", () -> new ButterSwordItem(BMItemBehaviors.BUTTER, BUTTER_SWORD_SET, 3, -2.4F, new Item.Properties().food(Foods.BAKED_POTATO)));
