...
public class AxolotlTest {
    ...
    public static final DeferredItem<Item> FRUTIFERY_SINGULARITY_VANILLA = ITEMS.register("frutifery_singularity_vanilla", () -> new Item(new Item.Properties().rarity(Rarity.UNCOMMON)));
    ...
    public static final DeferredItem<Item> MEATY_SINGULARITY_VANILLA = ITEMS.register("meaty_singularity_vanilla", () -> new Item(new Item.Properties().rarity(Rarity.UNCOMMON)));
    ...
    public static final DeferredItem<Item> VEGETABLY_SINGULARITY_REVARIED = ITEMS.register("vegetably_singularity_revaried", () -> new Item(new Item.Properties().rarity(Rarity.UNCOMMON)));
    ...
    public static final DeferredItem<Item> TWO_THIRDS_HILLARY_NUGGET = ITEMS.register("two_thirds_hillary_nugget", () -> new Item(new Item.Properties().rarity(Rarity.UNCOMMON)));
    ...
    public static final DeferredItem<Item> TWO_THIRDS_HILLARY_INGOT = ITEMS.register("two_thirds_hillary_ingot", () -> new Item(new Item.Properties().rarity(Rarity.UNCOMMON)));
    ...
    public static final DeferredItem<Item> HILLARY_BUCKET = ITEMS.register("hillary_bucket", () -> new BucketItem(BMFluids.HILLARY.get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    public static final DeferredItem<Item> MILKLLARY_BUCKET = ITEMS.register("milkllary_bucket", () -> new BucketItem(BMFluids.MILKLLARY.get(), new Item.Properties().craftRemainder(Items.BUCKET).rarity(Rarity.UNCOMMON).stacksTo(1)));
    ...
    public static final DeferredItem<Item> RED_YELLOW_DYE = ITEMS.register("red_yellow_dye", () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> QUEEN_LUCY_BATTLE_INFO = ITEMS.register("queen_lucy_battle_info", () -> new DescriptiveItem(Component.translatable("tooltip.backmath.queen_lucy_battle_info"), new Item.Properties().rarity(Rarity.EPIC).fireResistant()));
    ...
    public static final DeferredItem<Item> ALCOHOL_GEL = ITEMS.register("alcohol_gel", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> HILLARY_DISINFECTANT = ITEMS.register("hillary_disinfectant", () -> new Item(new Item.Properties().stacksTo(2)));
    public static final DeferredItem<Item> HILLARY_DEODORANT = ITEMS.register("hillary_deodorant", () -> new Item(new Item.Properties().stacksTo(16)));
    public static final DeferredItem<Item> GLUE = ITEMS.register("glue", () -> new Item(new Item.Properties().durability(384)));
    public static final DeferredItem<Item> TWO_THIRDS_HILLARY_KEY = ITEMS.register("two_thirds_hillary_key", () -> new Item(new Item.Properties().rarity(Rarity.UNCOMMON).stacksTo(1)));
    ...
    public static final DeferredItem<Item> SPATH_SIRIUS_BLACK = ITEMS.register("spath_sirius_black", () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> WANDERER_TERMIAN_SPAWN_EGG = ITEMS.register("wanderer_termian_spawn_egg", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> ANGRY_TERMIAN_SPAWN_EGG = ITEMS.register("angry_termian_spawn_egg", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> INSOMNIAC_TERMIAN_SPAWN_EGG = ITEMS.register("insomniac_termian_spawn_egg", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> ARCHER_INSOMNIAC_TERMIAN_SPAWN_EGG = ITEMS.register("archer_insomniac_termian_spawn_egg", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> WARRIOR_TERMIAN_SPAWN_EGG = ITEMS.register("warrior_termian_spawn_egg", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> QUEEN_LUCY_SPAWN_EGG = ITEMS.register("queen_lucy_spawn_egg", () -> new Item(new Item.Properties().rarity(Rarity.EPIC).fireResistant()));
    public static final DeferredItem<Item> QUEEN_LUCY_PET_SPAWN_EGG = ITEMS.register("queen_lucy_pet_spawn_egg", () -> new Item(new Item.Properties().rarity(Rarity.EPIC).fireResistant()));
    ...
    public static final DeferredItem<Item> SHY_ALCALYTE_SPAWN_EGG = ITEMS.register("shy_alcalyte_spawn_egg", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> COLLECTOR_ALCALYTE_SPAWN_EGG = ITEMS.register("collector_alcalyte_spawn_egg", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> MALAIKA_SPAWN_EGG = ITEMS.register("malaika_spawn_egg", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> INSOMNIAC_ZOMBIE_SPAWN_EGG = ITEMS.register("insomniac_zombie_spawn_egg", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> ZOMBIE_ALCALYTE_SPAWN_EGG = ITEMS.register("zombie_alcalyte_spawn_egg", () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> MUSIC_DISC_WELLERMAN = ITEMS.register("music_disc_wellerman", () -> new Item(new Item.Properties().jukeboxPlayable(BMJukeboxSongs.WELLERMAN).stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final DeferredItem<Item> MUSIC_DISC_SNOWMAN = ITEMS.register("music_disc_snowman", () -> new Item(new Item.Properties().jukeboxPlayable(BMJukeboxSongs.SNOWMAN).stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final DeferredItem<Item> MUSIC_DISC_DUET_CHALLENGE = ITEMS.register("music_disc_duet_challenge", () -> new Item(new Item.Properties().jukeboxPlayable(BMJukeboxSongs.DUET_CHALLENGE).stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final DeferredItem<Item> MUSIC_DISC_ARCADE = ITEMS.register("music_disc_arcade", () -> new Item(new Item.Properties().jukeboxPlayable(BMJukeboxSongs.ARCADE).stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final DeferredItem<Item> MUSIC_DISC_SUGAR_CRASH = ITEMS.register("music_disc_sugar_crash", () -> new Item(new Item.Properties().jukeboxPlayable(BMJukeboxSongs.SUGAR_CRASH).stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final DeferredItem<Item> MUSIC_DISC_O_ONIBUS_VAI_DERRAPAR = ITEMS.register("music_disc_bus", () -> new Item(new Item.Properties().jukeboxPlayable(BMJukeboxSongs.O_ONIBUS_VAI_DERRAPAR).stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final DeferredItem<Item> MUSIC_DISC_IEVAN_POLKKA = ITEMS.register("music_disc_ievan_polkka", () -> new Item(new Item.Properties().jukeboxPlayable(BMJukeboxSongs.IEVAN_POLKKA).stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final DeferredItem<Item> MUSIC_DISC_NEVER_GONNA_GIVE_YOU_UP = ITEMS.register("music_disc_rick_roll", () -> new Item(new Item.Properties().jukeboxPlayable(BMJukeboxSongs.NEVER_GONNA_GIVE_YOU_UP).stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final DeferredItem<Item> MUSIC_DISC_BEGGIN = ITEMS.register("music_disc_beggin", () -> new Item(new Item.Properties().jukeboxPlayable(BMJukeboxSongs.BEGGIN).stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final DeferredItem<Item> MUSIC_DISC_STAY = ITEMS.register("music_disc_stay", () -> new Item(new Item.Properties().jukeboxPlayable(BMJukeboxSongs.STAY).stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final DeferredItem<Item> MUSIC_DISC_THE_FLYING_ARM = ITEMS.register("music_disc_flying_arm", () -> new Item(new Item.Properties().jukeboxPlayable(BMJukeboxSongs.THE_FLYING_ARM).stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final DeferredItem<Item> MUSIC_DISC_DRAMATIC_INTRO_1 = ITEMS.register("music_disc_dramatic_intro_1", () -> new Item(new Item.Properties().jukeboxPlayable(BMJukeboxSongs.DRAMATIC_INTRO_1).stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final DeferredItem<Item> MUSIC_DISC_DRAMATIC_INTRO_2 = ITEMS.register("music_disc_dramatic_intro_2", () -> new Item(new Item.Properties().jukeboxPlayable(BMJukeboxSongs.DRAMATIC_INTRO_2).stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final DeferredItem<Item> MUSIC_DISC_DRAMATIC_INTRO_3 = ITEMS.register("music_disc_dramatic_intro_3", () -> new Item(new Item.Properties().jukeboxPlayable(BMJukeboxSongs.DRAMATIC_INTRO_3).stacksTo(1).rarity(Rarity.UNCOMMON)));
    ...
    public static final DeferredItem<Item> INSOMNIAC_TERMIAN_SLEEPWEAR_BLOUSE = ITEMS.register("insomniac_termian_sleepwear_blouse", () -> new BMArmorItem(INSOMNIAC_TERMIAN_SLEEPWEAR_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(5))));
    public static final DeferredItem<Item> INSOMNIAC_TERMIAN_SLEEPWEAR_PANTS = ITEMS.register("insomniac_termian_sleepwear_pants", () -> new BMArmorItem(INSOMNIAC_TERMIAN_SLEEPWEAR_ARMOR, ArmorItem.Type.LEGGINGS, new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(5))));
    ...
    public static final DeferredItem<Item> ARCHER_ALCALYTE_HOOD = ITEMS.register("archer_alcalyte_hood", () -> new BMArmorItem(ARCHER_ALCALYTE_ARMOR, ArmorItem.Type.HELMET, new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(15)).rarity(Rarity.UNCOMMON)));
    public static final DeferredItem<Item> ARCHER_ALCALYTE_VEST = ITEMS.register("archer_alcalyte_vest", () -> new BMArmorItem(ARCHER_ALCALYTE_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Properties().durability(ArmorItem.Type.CHESTPLATE.getDurability(15)).rarity(Rarity.UNCOMMON)));
    ...
    public static final DeferredItem<Item> GOLDEN_PLATED = ITEMS.register("golden_plated", () -> new ArmorItem(GOLDEN_PLATED_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Properties().rarity(Rarity.UNCOMMON).durability(ArmorItem.Type.CHESTPLATE.getDurability(17))));
    ...
    public static final DeferredItem<Item> CAT_TIARA = ITEMS.register("cat_tiara", () -> new BMArmorItem(CAT_TIARA_ARMOR, ArmorItem.Type.HELMET, new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(37))));
    ...
    public static final DeferredItem<Item> KARATE_HEADBAND = ITEMS.register("karate_headband", () -> new KarateHeadbandItem(KARATE_HEADBAND_ARMOR, ArmorItem.Type.HELMET, new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(4))));
    ...
    public static final DeferredItem<Item> MID_TERM_LONGSWORD = ITEMS.register("mid_term_longsword", () -> new MidTermLongswordItem(MID_TERM_SET, 12, -3.4F, new Item.Properties().fireResistant().rarity(Rarity.RARE)));
    ...
    public static final DeferredItem<Item> MILKED_GOLDEN_PATTY = ITEMS.register("milked_golden_patty", () -> new BMSwordItem(BMItemBehaviors.MILKED_SWORD, GOLDEN_PATTY_SET, 3, -2.4F, new Item.Properties().rarity(Rarity.UNCOMMON).food(Foods.GOLDEN_APPLE)));
    public static final DeferredItem<Item> MILKED_BUTTER_SWORD = ITEMS.register("milked_butter_sword", () -> new ButterSwordItem(BMItemBehaviors.MILKED_BUTTER, BUTTER_SWORD_SET, 3, -2.4F, new Item.Properties().component(BMDataComponents.STORED_EXPERIENCE, 500).food(Foods.BAKED_POTATO)));
    ...
    public static final DeferredItem<Item> ANGELIC_SPOON = ITEMS.register("angelic_spoon", () -> new AngelicSpoonItem(ANGELIC_SET, 1.5F, -3, new Item.Properties()));
    ...
    public static final DeferredItem<Item> GOLDEN_PATTY = ITEMS.register("golden_patty", () -> new BMSwordItem(GOLDEN_PATTY_SET, 3, -2.4F, new Item.Properties().rarity(Rarity.UNCOMMON).food(Foods.GOLDEN_APPLE)));
    public static final DeferredItem<Item> BUTTER_SWORD = ITEMS.register("butter_sword", () -> new ButterSwordItem(BMItemBehaviors.BUTTER, BUTTER_SWORD_SET, 3, -2.4F, new Item.Properties().component(BMDataComponents.STORED_EXPERIENCE, 500).food(Foods.BAKED_POTATO)));
    ...
    public static final DeferredItem<Item> RAINBOW_PENCIL = ITEMS.register("rainbow_pencil", () -> new BMSwordItem(BMItemBehaviors.RAINBOW_PENCIL, RAINBOW_PENCIL_SET, 1, -2.4F, new Item.Properties().rarity(Rarity.RARE).food(Foods.APPLE))); // It used to place down Lava.
    ...
    public static final DeferredItem<Item> QUEEN_LUCY_SUMMONER_STAFF = ITEMS.register("queen_lucy_summoner_staff", () -> new QueenLucySummonerStaffItem(new Item.Properties().attributes(QueenLucySummonerStaffItem.createAttributes()).component(DataComponents.TOOL, QueenLucySummonerStaffItem.createToolProperties()).rarity(Rarity.EPIC).durability(1500).fireResistant()));
    public static final DeferredItem<Item> WATER_TALC_POWDER = ITEMS.register("water_talc_powder", () -> new WaterTalcPowderItem(WATER_TALC_POWDER_SET, 0, -2.4F, new Item.Properties().food(BMFoods.WATER_TALCUM_POWDER).stacksTo(1)));
    public static final DeferredItem<Item> INSOFLINT_AND_ALJANSTEEL = ITEMS.register("insoflint_and_aljansteel", () -> new InsoflintAndAljansteelItem(new Item.Properties().durability(250)));
    ...
    public static final DeferredItem<Item> WATER_POT = ITEMS.register("water_pot", () -> new JamItem(new Item.Properties().craftRemainder(AxolotlTest.JAM_POT.get()).food(Foods.SWEET_BERRIES)));
    ...
    public static final DeferredItem<Item> HILLARY_JAM = ITEMS.register("hillary_jam", () -> new JamItem(new Item.Properties().craftRemainder(AxolotlTest.JAM_POT.get()).food(Foods.APPLE)));
    public static final DeferredItem<Item> MILKLLARY_JAM = ITEMS.register("milkllary_jam", () -> new JamItem(new Item.Properties().craftRemainder(AxolotlTest.JAM_POT.get()).rarity(Rarity.UNCOMMON).food(Foods.BAKED_POTATO)));
    ...
    public static final DeferredItem<Item> WATER_DROPLET_BREAD = ITEMS.register("water_droplet_bread", () -> new Item(new Item.Properties().food(BMFoods.WATER_POT_BREAD)));
    public static final DeferredItem<Item> ZE_DROPLET_BREAD = ITEMS.register("ze_droplet_bread", () -> new Item(new Item.Properties().food(BMFoods.WATER_POT_BREAD)));
    public static final DeferredItem<Item> HILLARY_JAM_BREAD = ITEMS.register("hillary_jam_bread", () -> new Item(new Item.Properties().food(BMFoods.HILLARY_JAM_BREAD)));
    public static final DeferredItem<Item> MILKLLARY_JAM_BREAD = ITEMS.register("milkllary_jam_bread", () -> new Item(new Item.Properties().rarity(Rarity.UNCOMMON).food(BMFoods.MILKLLARY_JAM_BREAD)));
...
//    public static final DeferredItem<Item> AMARACAMEL_BATTER_BAG = ITEMS.register("amaracamel_batter_bag", () -> new PlaceableBagItem(BMBlocks.AMARACAMEL_BATTER_BAG.get(), new Item.Properties()));
    ...
    public static final DeferredItem<Item> FRIED_EGG_BAG = ITEMS.register("fried_egg_bag", () -> new BagItem(new Item.Properties().component(BMDataComponents.BAG_LOOT_TABLE, BMResourceLocations.FRIED_EGG_BAG)));
    public static final DeferredItem<Item> EMPTY_FRIED_EGG_BAG = ITEMS.register("empty_fried_egg_bag", () -> new Item(new Item.Properties()));
...
//    public static final DeferredItem<Item> BOOT_PACK = ITEMS.register("boot_pack", () -> new PlaceableBagItem(BMBlocks.BOOT_PACK.get(), new Item.Properties()));
    ...
    public static final DeferredItem<Item> QUEEN_LUCY_BATTLE_PACK = ITEMS.register("queen_lucy_battle_pack", () -> new BagItem(new Item.Properties().fireResistant().component(BMDataComponents.BAG_LOOT_TABLE, BMResourceLocations.QUEEN_LUCY_BATTLE_PACK).rarity(Rarity.EPIC)));
    public static final DeferredItem<Item> FOOD_BAG = ITEMS.register("food_bag", () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> FRIED_EGG = ITEMS.register("fried_egg", () -> new Item(new Item.Properties().food(Foods.BAKED_POTATO)));
