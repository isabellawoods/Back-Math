...
public class BMHoeItem extends HoeItem {
    ...
    public BMHoeItem(Supplier<ItemBehavior> behavior, Tier tier, float attackDamage, float swingSpeed, Properties properties) {
        super(tier, properties.attributes(createAttributes(tier, attackDamage, swingSpeed)));
        this.behavior = behavior;
    }

    public BMHoeItem(Tier tier, float attackDamage, float swingSpeed, Properties properties) {
