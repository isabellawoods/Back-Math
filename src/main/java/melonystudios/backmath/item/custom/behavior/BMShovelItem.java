...
public class BMShovelItem extends ShovelItem {
    ...
    public BMShovelItem(Supplier<ItemBehavior> behavior, Tier tier, float attackDamage, float swingSpeed, Properties properties) {
        super(tier, properties.attributes(createAttributes(tier, attackDamage, swingSpeed)));
        this.behavior = behavior;
    }

    public BMShovelItem(Tier tier, float attackDamage, float swingSpeed, Properties properties) {
