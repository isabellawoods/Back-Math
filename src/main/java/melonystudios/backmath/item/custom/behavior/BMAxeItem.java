...
public class BMAxeItem extends AxeItem {
    ...
    public BMAxeItem(Supplier<ItemBehavior> behavior, Tier tier, float attackDamage, float swingSpeed, Properties properties) {
        super(tier, properties.attributes(createAttributes(tier, attackDamage, swingSpeed)));
        this.behavior = behavior;
    }

    public BMAxeItem(Tier tier, float attackDamage, float swingSpeed, Properties properties) {
